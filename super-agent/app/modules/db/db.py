...
def main():
    ...
    # db.collect_data("Anirban", "Today was raining while the concrete arrived, had to stop the work.", "Image1")
    ...
    # db.collect_data("Anirban", "Rain affected the drying process of painted walls.", "Image21")
    # db.collect_data("Anirban", "Morning safety briefing held before shift; all protocols reviewed.", "Image11")
    # db.collect_data("Tobi", "Second floor elevator shaft framework completed successfully.", "Image12")
    # db.collect_data("Anirban", "Site perimeter fencing inspected and minor repairs made.", "Image13")
    # db.collect_data("Ramtin", "HVAC duct installation has started on the ground floor.", "Image14")
    # db.collect_data("Dhwani", "Waterproofing membranes installed on the rooftop structure.", "Image15")
    # db.collect_data("Anirban", "Lighting fixtures installed in the main hall area.", "Image16")
    # db.collect_data("Cris", "Cranes were inspected for maintenance and cleared for use.", "Image17")
    # db.collect_data("Tobi", "Concrete formwork dismantled after curing period completed.", "Image18")
    # db.collect_data("Silin", "Fire alarm system tested; all devices functioning properly.", "Image19")
    # db.collect_data("Ramtin", "Temporary walkways reconfigured to improve site access.", "Image20")
